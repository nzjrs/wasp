...
class MsgArea(gtk.HBox):
    ...
    def __init__(self, buttons, **kwargs):
        ...
        self.__primary_label = None
        self.__secondary_label = None
    ...
    def set_text_and_icon(self, stockid, primary_text, secondary_text=None):
        ...
        if secondary_text:
            ...
            self.__secondary_label = secondary_label
    
        self.set_contents(hbox_content)

    def update_text(self, primary_text, secondary_text):
        if primary_text and self.__primary_label:
            markup = "<b>%s</b>" % primary_text
            self.__primary_label.set_markup(markup)
        if secondary_text and self.__secondary_label:
            markup = "<small>%s</small>" % secondary_text
            self.__secondary_label.set_markup(markup)
